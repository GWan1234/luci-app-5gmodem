...
```sh
curl -L https://github.com/fildunsky/luci-app-5gmodem/releases/download/v2.8.8/luci-i18n-5gmodem-ja.apk > /tmp/luci-i18n-5gmodem-ja.apk
...
**日本語表示**:
```sh
curl -L https://github.com/fildunsky/luci-app-5gmodem/releases/download/v2.8.8/luci-i18n-5gmodem-ja.ipk > /tmp/luci-i18n-5gmodem-ja.ipk
