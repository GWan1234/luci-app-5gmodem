...
# опрашивались КАЖДЫЙ опрос (5 из 6 AT-вызовов = основные ~секунды). При смене
# SIM (IMSI из батча != сохранённого) кэш сбрасывается.
#
