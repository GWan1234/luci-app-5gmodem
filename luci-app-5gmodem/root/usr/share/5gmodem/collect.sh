...
'
	...
	echo "в загрузчик при КАЖДОЙ загрузке."
	echo "С версии 2.4.26 приложение при установленном fastboot выводит такой"
	echo "модем из загрузчика само (hotplug, не чаще раза в минуту, до 3 попыток;"
	echo "выключатель: uci set 5gmodem.@5gmodem[0].fastboot_rescue='0'). EDL"
	echo "(05c6:9008) не трогается никогда. В загрузчик приложение не переводит:"
	echo "прошивочные режимы - не наша зона."
}
