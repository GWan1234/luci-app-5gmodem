...
network.registerPatternVirtual(/^qmip-.+$/);

return network.registerProtocol('qmip', {
	getI18n: function() {
		return _('QMI+MM (shared proxy, ModemManager for management)');
	},

	getIfname: function() {
		return this._ubus('l3_device') || 'qmip-%s'.format(this.sid);
	},
