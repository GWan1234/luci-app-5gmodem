...
# .apk (OpenWrt 25.12.x)
```sh
curl -L https://github.com/fildunsky/luci-app-5gmodem/releases/download/v1.5.5/luci-app-5gmodem-1.5.5-r1.apk > /tmp/luci-app-5gmodem.apk
...
# .ipk (OpenWrt 24.10.x)
```sh
curl -L https://github.com/fildunsky/luci-app-5gmodem/releases/download/v1.5.5/luci-app-5gmodem_1.5.5-r1_all.ipk > /tmp/luci-app-5gmodem.ipk
opkg update
