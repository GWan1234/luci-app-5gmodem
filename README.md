...
curl -L https://github.com/fildunsky/luci-app-5gmodem/releases/download/v2.4.11/luci-app-5gmodem-2.4.11-r1.apk > /tmp/luci-app-5gmodem.apk
...
curl -L https://github.com/fildunsky/luci-app-5gmodem/releases/download/v2.4.11/luci-app-5gmodem_2.4.11-r1_all.ipk > /tmp/luci-app-5gmodem.ipk
