...
curl -L https://github.com/fildunsky/luci-app-5gmodem/releases/download/v1.6.1/luci-app-5gmodem-1.6.1-r1.apk > /tmp/luci-app-5gmodem.apk
...
curl -L https://github.com/fildunsky/luci-app-5gmodem/releases/download/v1.6.1/luci-app-5gmodem_1.6.1-r1_all.ipk > /tmp/luci-app-5gmodem.ipk
