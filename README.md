...
curl -L https://github.com/fildunsky/luci-app-5gmodem/releases/download/v2.2.8/luci-app-5gmodem-2.2.8-r1.apk > /tmp/luci-app-5gmodem.apk
...
curl -L https://github.com/fildunsky/luci-app-5gmodem/releases/download/v2.2.8/luci-app-5gmodem_2.2.8-r1_all.ipk > /tmp/luci-app-5gmodem.ipk
