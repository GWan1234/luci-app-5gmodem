...
curl -L https://github.com/fildunsky/luci-app-5gmodem/releases/download/v2.8.3/luci-app-5gmodem-2.8.3-r1.apk > /tmp/luci-app-5gmodem.apk
apk add /tmp/luci-app-5gmodem.apk --allow-untrusted
```

**中文界面**：再安装本应用的简体中文语言包，并确保 LuCI 本身的中文包已安装：
```sh
curl -L https://github.com/fildunsky/luci-app-5gmodem/releases/download/v2.8.3/luci-i18n-5gmodem-zh-cn.apk > /tmp/luci-i18n-5gmodem-zh-cn.apk
...
curl -L https://github.com/fildunsky/luci-app-5gmodem/releases/download/v2.8.3/luci-app-5gmodem_2.8.3-r1_all.ipk > /tmp/luci-app-5gmodem.ipk
opkg install /tmp/luci-app-5gmodem.ipk
```

**中文界面**：再安装本应用的简体中文语言包，并确保 LuCI 本身的中文包已安装：
```sh
curl -L https://github.com/fildunsky/luci-app-5gmodem/releases/download/v2.8.3/luci-i18n-5gmodem-zh-cn.ipk > /tmp/luci-i18n-5gmodem-zh-cn.ipk
